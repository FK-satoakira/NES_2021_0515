...
//	資金
	...
	public static void explanation() {
		System.out.println("＊この説明文を消したい場合はnc20210515_processor/Main.javaのexplanationメソッドをコメントアウトしてください。\n"
				+"慣れてくれば見無くてもできるようになります。カードの価格とコストも同様にコメントアウトできます。その場合は\n"
				+ "nc20210515_card/Card.javaのtoStringの「慣れてくれば価格とコスト...」と既存の表示のコメントアウトを切り替えてください＊\n "
			...
			+ "【施:社宅:8:2:✖】 労働者限度数を +1\n"
			+ "【施:倉庫:10:2:✖】 手札限度数を +1\n"
			+ "説明が長いですが数回ゲームをやればすぐに慣れます。\n"
			+ "スコアは資金+土地資産+ボーンスの合計です。\n"
			+ "ハマってしまう方もおられるかもしれないので、やりすぎにはご注意くださいそれではゲームスタート！");
		System.out.println();
	}
}
